    ...
    public VaccinationResponse createVaccination(VaccinationCreateRequest request, AuthenticatedUser currentUser) {
        ...
        Vaccination vaccination =
                Vaccination.builder()
                        ...
                        .build();
        vaccination.setId(sequenceGeneratorService.generateSequence(Vaccination.class.getSimpleName()));
    ...
    public MedicationResponse createMedication(MedicationCreateRequest request, AuthenticatedUser currentUser) {
        ...
        Medication medication =
                Medication.builder()
                        ...
                        .withdrawalEndDate(request.withdrawalEndDate())
                        .build();
        medication.setId(sequenceGeneratorService.generateSequence(Medication.class.getSimpleName()));
