...
const GooeyNav: React.FC<GooeyNavProps> = ({
  ...
  const handleClick = (e: React.MouseEvent<HTMLElement>, index: number, customOnClick?: (e: React.MouseEvent) => void) => {
    if (customOnClick) {
      customOnClick(e);
    }
  ...
  const handleKeyDown = (e: React.KeyboardEvent<HTMLElement>, index: number, customOnClick?: (e: React.MouseEvent) => void) => {
    if (e.key === 'Enter' || e.key === ' ') {
      e.preventDefault();
      handleClick(e as any, index, customOnClick);
    }
  };
